...
import application.filter.CustomAuthentifcationFilter;
import application.filter.CustomAuthorisationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        customAuthentifcationFilter.setFilterProcessesUrl("/api/login");
        http.csrf().disable();
